 ...
 * @desc:
 */
public class TagViewByViewGroup2 extends ViewGroup {
    ...
    public TagViewByViewGroup2(Context context) {
        super(context);
    }

    public TagViewByViewGroup2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
